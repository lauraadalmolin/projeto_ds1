...
echo 							"<a href='CRUD_Indicacao/update/" . $indicacao->id . "'><img src='../images/icons/edit1.png'>";
echo 							"</img></a>";
echo 							"<a href='CRUD_Indicacao/delete/" . $indicacao->id . "'><img src='../images/icons/delete1.png'>";
echo 							"</img></a>";
echo 							"</div>";
